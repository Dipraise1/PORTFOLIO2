...
const originalContent = {
  ...
  contact: {
    ...
    conversationText: "I'm always excited to hear about new Web3 projects, mobile app ideas, and blockchain development opportunities. Whether you need smart contract development, DeFi protocol integration, NFT marketplace creation, AI agent services, or Flutter/React Native mobile app development, I'm here to help bring your vision to life.",
    quickConnect: "Quick Connect",
    sendMessage: "Send a Message",
    messageDescription: "I'd love to hear about your project or ideas!",
    form: {
      fullName: "Full Name",
      ...
      messagePlaceholder: "Describe your project, timeline, budget, or any specific requirements you have in mind...",
      visionText: "Tell me about your vision and I'll help bring it to life",
  ...
  footer: {
    description: "Professional Web3 developer specializing in smart contracts, DeFi protocols, NFT marketplaces, and AI agents. Building the future of decentralized internet.",
    social: "Social",
    twitter: "Twitter",
    github: "GitHub",
    telegram: "Telegram",

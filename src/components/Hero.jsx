            ...
            <div className="space-y-5 sm:space-y-6">
              ...
              >
                <a href="https://github.com/Dipraise1" target="_blank" rel="noreferrer"
                  className="hover:text-[var(--color-primary)] transition-colors p-2" aria-label="GitHub">
                  <Github size={22} />
                </a>
                <a href="https://x.com/divinecodes11?s=21" target="_blank" rel="noreferrer"
                  className="hover:text-[var(--color-primary)] transition-colors p-2" aria-label="X (Twitter)">
                  <XIcon size={22} />
                </a>
                <a href="https://www.tiktok.com/@divin3.eth?_r=1&_t=ZS-95Sk7mHgmzE" target="_blank" rel="noreferrer"
                  className="hover:text-pink-400 transition-colors p-2" aria-label="TikTok">
                  <TikTokIcon size={22} />
                </a>
                <a href="https://t.me/jokersrequired" target="_blank" rel="noreferrer"
                  className="hover:text-[var(--color-primary)] transition-colors p-2" aria-label="Telegram">
